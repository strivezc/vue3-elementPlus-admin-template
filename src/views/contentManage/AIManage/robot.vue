  ...
  <div class="app-container">
    ...
    >
      ...
      <el-row>
        <el-col :sm="24" :md="12" :lg="8" :xl="8">
          <el-form-item>
            <el-button type="primary" native-type="submit" @click="getList" v-permission="'2310'"
              >查询</el-button
            >
            <el-button type="success" @click="add" v-permission="'2312'">新增</el-button>
          </el-form-item>
        </el-col>
      </el-row>
    </el-form>
    ...
    >
      ...
      >
        ...
        <el-form-item label="个人描述:" prop="selfInfo">
          <el-input
            class="form-textarea"
        ...
        <el-form-item prop="imgUrl" label="封面图:">
          <div class="flex-column">
            ...
            >
              ...
              <template #tip>
                <span class="remarks ml15">注：建议尺寸：100px*100px</span>
              </template>
            </el-upload>
        ...
        <el-form-item label="提示文案:">
          <editor v-model="form.content" style="width: 90%" :height="250" />
        </el-form-item>
      </el-form>
      <template #footer>
...
const state = reactive({
  ...
  formRules: {
    ...
    selfInfo: [{ required: true, message: '请输入自我介绍！', trigger: 'blur' }],
