  ...
  <div class="app-container home">
    <div class="home-data">
      ...
      >
        <el-row>
          <el-col :sm="24" :md="24" :lg="24" :xl="24">
            ...
            <el-form-item>
              <el-button type="primary" native-type="submit" @click="search" v-permission="'9200'"
                >查询</el-button
              >
            </el-form-item>
          </el-col>
      ...
      <div class="home-card">
        ...
        <el-card shadow="never">
          {{ dataInfo.participateComCount || 0 }}
          <p>参与客户数</p>
          <el-popover
            :width="250"
            placement="right">
            ...
            <span>
              筛选时段内，所有有上架中任务的客户数（只要有上架中任务即视为参与）；
            </span>
          </el-popover>
        </el-card>
        <el-card shadow="never">
...
<script setup name="StatisticsCustomer">
...
const getList = async () => {
  await ruleFormRef.value.validate(async (valid, fields) => {
    if (valid) {
      try {
        const { data } = await proxy.$http.index.getNewCustomerStatistics(formData.value)
        if (data) {
          ...
          dataInfo.value = {
            ...
            participateComCount: data.participateComCount,
