      ...
      >
        <el-row>
          <el-col :sm="24" :md="24" :lg="24" :xl="24">
            ...
            <el-form-item>
              <el-button type="primary" native-type="submit" @click="search" v-permission="'9000'"
                >查询</el-button
              >
            </el-form-item>
          </el-col>
...
<script setup name="StatisticsTask">
...
const getList = async () => {
  await ruleFormRef.value.validate(async (valid, fields) => {
    if (valid) {
      try {
        const { data } = await proxy.$http.index.getNewTaskStatistics(formData.value)
        if (data) {
          ...
          dataInfo.value = {
            ...
            averageSucPer: data.averageSucPer,
